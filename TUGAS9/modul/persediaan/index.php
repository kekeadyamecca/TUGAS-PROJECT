            ...
            <tr>
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        <div class="mb-3">
                                            <label for="barang" class="form-label">Barang</label>
                                            <input class="form-control bg-secondary-subtle" type="text"nama="barang" value="<?= $row_persediaan['nama_barang'];?>" readonly>
                                        </div>
                                        <div class="mb-3">
                ...
                <div class="modal fade" id="modalKeluar<?= $row_persediaan['id_persediaan'];?>"tabindex="-1"aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-tittle fs-5" id="exampleModalLabel">Stok Keluar</h1>
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                             </div>
